package omitempty_disabled_test
...
import (
	...
	generated "github.com/gqlgo/gqlgenc/generator/testdata/omitempty_disabled/expected"
)
...
// are correctly deserialized when values are present, even without omitempty tags.
...
// TestE2E_GetUserNullable tests that nullable fields without dummy directives
// are still deserialized (gqldummy returns random values for them).
func TestE2E_GetUserNullable(t *testing.T) {
	...
	// The key test is that json tags without omitempty work correctly.
